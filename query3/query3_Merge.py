...
# Set the adaptive autoBroadcastJoinThreshold to a specific value (e.g., 1000000000)
...
result = spark.sql("""
    ...
    SELECT /*+ MERGEJOIN(cd)*/ SUBSTRING(rc.ZIPcode, 1, 5) AS zip_code,
